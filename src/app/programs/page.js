    ...
    <main className="max-w-8xl mx-auto py-10 md:py-[4rem] flex flex-col gap-[3rem]">
      ...
      <div className="w-full relative flex items-center justify-center h-[400px] md:h-[500px]">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
          ...
          <div className="text-white text-base md:text-sm font-medium drop-shadow-lg">
            CREATIVE ACTIVITIES / RESILIENCE BUILDING / AWARENESS & EDUCATION
          </div>
        </div>
      </div>
      {/* intro */}
      <div className="max-w-6xl mx-auto grid grid-cols-2 items-center w-full">
        <div>
      ...
      <div className="flex relative flex-col gap-5 min-h-fit max-w-6xl mx-auto w-full">
      ...
      {/* Program 1: creative solution */}
      <div className="flex relative flex-col gap-5 min-h-screen max-w-6xl mx-auto w-full">
        <p className="text-sm sticky top-0 bg-white/50 backdrop-blur-3xl w-fit !p-2 rounded-sm tracking-tighter flex items-center gap-2">
